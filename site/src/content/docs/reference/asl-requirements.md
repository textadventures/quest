...
-   As of v5.4, if an **OutputText** function is defined, all text sent to the [msg](/reference/script-commands#msg) command will be sent through it, instead of text being printed directly.
