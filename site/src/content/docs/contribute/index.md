...
This page is about working on Quest Viva itself. To get it building on your own machine, see [Building from source](/contribute/building-from-source).
...
- [Overriding functions](/customise/overriding) - replace a single built-in function with your own version, in one game.
- [Using libraries](/customise/libraries) - package up a set of changes to share between your games, or with other people.
...
Before you open the pull request, run the checks that apply to what you changed - the unit tests, the editor's lint and type checks, the documentation site's own checks, and any end-to-end scripts covering the area. [Building from source](/contribute/building-from-source#tests-and-checks) lists them.
