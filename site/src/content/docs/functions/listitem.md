...
Usually you will know the type of list that you're passing in, so you should use the [StringListItem](/functions/stringlistitem) or [ObjectListItem](/functions/objectlistitem) functions instead.
