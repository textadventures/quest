...
Note that this is different to the [list remove](/scripts/list_remove) script command, as that removes the item from the original list. ListExclude by contrast returns a copy of the list - the original list is unaffected.
