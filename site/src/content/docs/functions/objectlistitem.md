...
This could be used with [GetRandomInt](/functions/getrandomint) to remove an item from the players inventory ([ScopeInventory](/functions/corelibrary/scopeinventory)) and place it into the current room (for example, if you're creating a poltergeist or thief).
