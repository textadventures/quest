...
Sometimes the verbs should change during the game - a "Wear" verb for a hat, which becomes "Remove" once the hat is on. (Objects set up as [wearables](/howto/objects/clothing) do this for you.)
