...
So you know all about types, from the [Using Types](/using_inherited_types) page, right? Let us do some more. In this tutorial we will add a new tab to an object so we can easily edit attributes of objects of that type.
