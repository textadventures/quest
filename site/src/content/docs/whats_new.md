...
Quest Viva is the successor to [Quest 5](https://textadventures.co.uk/quest), which had been going since 2011. Under the hood it's the same engine and the same scripting language, so if you know Quest 5, you already know Quest Viva - but a lot has changed around it.
