...
At the end of each turn, all active turnscripts will be run in alphabetical order, based on their name (if you do not give a turnscript a name, it will be given a default one that begins with a "k"!). See [here](/reference/functions/list#objectlistsort) for how Quest Viva orders alphabetically.



## Also consider...

If you are tracking whether a specific attribute has changed, a better way is to use a [change script](/change-scripts).
