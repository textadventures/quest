...
Fortunately, Quest Viva provides you with the Debugger, which lets you keep an eye on what's going on inside your game while you're testing it. When a game is running in preview from the editor, you can open the Debugger by clicking the "Debug" button.
