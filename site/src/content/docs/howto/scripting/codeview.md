...
Don't confuse this with the "Code view" button under a script, which shows a single script as [Quest script code](/howto/scripting/introtocoding). That one is an everyday tool. This one edits the whole file at once, and it's for the jobs the editor can't do.
...
- [Writing code](/howto/scripting/introtocoding) - editing a single script as code
- [Editing a library](/advanced-topics/using-libraries#editing-a-library)
