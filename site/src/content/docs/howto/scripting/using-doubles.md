...
Most games never need anything other than integers. Doubles tend to come up for things like tracking the progress of a ship across the ocean (or a spaceship across space), where the player specifies an angle and distance. For complex trigonometric calculations, you are into the realm of doubles.
