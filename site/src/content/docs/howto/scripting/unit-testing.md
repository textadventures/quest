...
Result (message)
  if (not HasInt(game, "testcount")) {
    game.testcount = 0
    game.testfailures = NewStringList()
  }
  if (message = null) {
    JS.addText (".")
  }
