...
If your game shows a map, see [Teleporting](/howto/rooms/map#teleporting) on the map page too.

## See also

- [Asking the player](/howto/scripting/asking-the-player) - more on `ShowMenu`
- [Score, health and money](/howto/score/score-health-money#money) - the money feature
