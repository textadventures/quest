...
The simplest answer is to only let the player teleport to rooms they've already visited, as many games do with fast travel. The [Fast travel](/howto/rooms/fast-travel#fast-travel-to-visited-rooms) page shows how to offer a menu of visited rooms.
