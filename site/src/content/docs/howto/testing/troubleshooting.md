...
- the room isn't dark (see [Handling light and dark](/howto/rooms/light-and-darkness))
...
See [How to use commands](/howto/commands/how-commands-work) for more on patterns.
...
You're doing arithmetic with an attribute that doesn't exist - usually because it's misspelt, or you never gave it a starting value. Set it on the object's _Attributes_ tab, or in the game's start script. See [Null](/understanding/values-and-types).
