...
The money format string is also used by the `DisplayMoney` function, and has a lot of options beyond the scope of this page, but can be seen [here](/functions/fn-string#displaymoney).
