...
- [Exits](/howto/world/exits) for everything else on the _Exit_ tab
- [Containers](/howto/world/containers) for locked boxes and chests, which use the same key settings as the door
