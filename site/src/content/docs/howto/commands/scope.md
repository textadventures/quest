...
- [Containers and surfaces](/howto/objects/containers) - open, closed and transparent, and what that does to reach
- [Handling multiple items (and all)](/howto/commands/multiple-items) - what TAKE ALL picks up
