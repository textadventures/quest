...
A stylesheet written inside a Quest string soon gets hard to read. For more than a few rules, add a Javascript element (select **Advanced** in the tree, then **Add JavaScript** - see [Calling the game from JavaScript](/howto/ux/ui-callback#adding-your-own-javascript)) and put the CSS in its file:
...
| `#commandPane`, `#customStatusPane` | The command pane and custom status pane - see [Panes](/howto/ux/custom-panes). |
...
- [JS functions](/js/) - all the `JS.` functions, including `setPanes` and `setInterfaceString`
- [Panes](/howto/ux/custom-panes) - the command pane and custom status pane
- [Calling the game from JavaScript](/howto/ux/ui-callback)
