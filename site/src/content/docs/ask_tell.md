...
Quest has a tab just for Ask/Tell, making it easy to set up each response (but you need to activate it on the Features tab of the game object).
...
The Quest Ask/About system is discussed in detail [here](/ask_about)
