...
Quest Viva's **WebPlayer** lets you serve any Quest Viva game to a web browser. The game code itself runs on the server, with the web browser sending the player's input and receiving the game's output.
...
First, you will need to download and install the [.NET 10 SDK](https://dotnet.microsoft.com/en-us/download).
