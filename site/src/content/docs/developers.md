...
To compile the source code, you will need Visual Studio, which you can download for free. More details on how to do that [here](/source_code).
...
See [Translating Quest](/translating_quest) for full information.
