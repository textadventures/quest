...
For how to do proper unit testing, see [Unit Testing](/unit_testing).
...
For more detail on creating functions with return values, see [Creating Functions](/creating_functions_which_return_a_value).
