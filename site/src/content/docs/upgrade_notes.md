...
-   new [text processor](/text_processor)
...
-   [walkthrough assertions](/using_walkthroughs#Assertions) let you test the value of expressions when a walkthrough is running
