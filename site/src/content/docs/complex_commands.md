...
This page discusses how to set up commands that use two (or more) objects. For simple commands, see [here](/commands).
...
There is more on regular expressions [here](/pattern_matching).
