...
Using this technique, you could change the [custom status pane](/custom_panes) into a control panel. Go to the game object, and turn on the custom status pane on the _Interface_ tab, then add this to the start script:
