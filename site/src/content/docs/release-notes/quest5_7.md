...
[Custom panes](/howto/ux/custom_panes)
...
-  [CloneObjectAndMoveHere](/functions/objects#cloneobjectandmovehere)
-  [CreateBiExits](/functions/objects#createbiexits): Creates an exit in the given direction, between the given rooms, and a second exit coming back.
-  [Equal](/functions/variables#equal): Compares any two things (comparing 4 and null will otherwise throw an error).
...
-  [FilterByType](/functions/list#filterbytype)
-  [FilterByAttribute](/functions/list#filterbyattribute)
-  [FilterByNotAttribute](/functions/list#filterbynotattribute)
-  [ObjectListToStringList](/functions/list#objectlisttostringlist)



### Get one at random

-  [PickOneString](/functions/random#pickonestring)
-  [PickOneObject](/functions/random#pickoneobject)
-  [PickOneChild](/functions/random#pickonechild)
-  [PickOneChildOfType](/functions/random#pickonechildoftype)
-  [PickOneExit](/functions/random#pickoneexit)
-  [PickOneUnlockedExit](/functions/random#pickoneunlockedexit)
...
[Clothing](/howto/world/wearables)
...
[Score, health and money](/howto/world/score_health_money)
...
[Advanced scripts](/howto/scripting/advanced_game_scripts)
...
[Advanced scope](/howto/commands/advanced_scope)
