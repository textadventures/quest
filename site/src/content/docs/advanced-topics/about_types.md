...
-   The [displayverbs](/attributes#displayverbs) and [inventoryverbs](/attributes#inventoryverbs) attributes are defaulted to give the standard buttons on the panes on the right-hand side of the Quest Viva screen ("Look at", "Take" and "Speak to" for the objects list, and "Look at", "Use" and "Drop" for the inventory list)
-   All objects are droppable by default
-   The neutral [gender](/attributes#gender) and [article](/attributes#article) ("it") are set
...
See also [Using inherited types](/advanced-topics/using_inherited_types) in the tutorial.
