...
This is a [regular expression](http://en.wikipedia.org/wiki/Regular_expression) ("regex") and is simply a more advanced form of command pattern, and is discussed in some detail [here](/pattern_matching). This [cheat sheet](http://regexlib.com/CheatSheet.aspx) is a handy syntax reference.
...
More on using libraries [here](/using_libraries).
