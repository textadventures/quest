...
(For dropping an attribute into a sentence like this, there is a shorter way that doesn't need a script at all - see [Varying your text](/tutorial/varying-your-text) later in the tutorial. It's worth knowing the expression form first, though, because expressions work everywhere, not just in text.)
