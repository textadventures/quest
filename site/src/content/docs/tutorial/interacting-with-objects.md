...
Whichever type you select, the object will behave in pretty much the same way, except that Quest Viva's default responses will make a lot more sense if you set this correctly. This is because setting the type will update the Gender and Article (you can also override these manually).

-   **Gender**: Usually "it", "he", "she" or "they". Quest Viva uses this for sentences such as "*It* is closed", "*He* says nothing" and so on.
-   **Article**: Usually "it", "him", "her" or "them". Quest Viva uses this for sentences such as "You pick *it* up", "You can't move *her*" and so on.
