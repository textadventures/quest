...
This tutorial guides you through creating your first gamebook game. If you want to create a text adventure instead, see [the main Quest Viva tutorial](/tutorial/creating-a-simple-game).
...
To publish your game, see [Publishing your game](/publishing) - it works the same way for a gamebook.
