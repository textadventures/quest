...
public class FilesTests
{
    ...
    public void TestIsSimpleStringExpression()
    {
        ...
        Assert.AreEqual(false,
            EditorUtility.IsSimpleStringExpression("\"simple string \\\"with nested quote\\\"\" + somevariable"));
    }
    ...
    public void TestConvertToSimpleStringExpression()
    {
        ...
        Assert.AreEqual("simple string \"with nested quote\"",
            EditorUtility.ConvertToSimpleStringExpression("\"simple string \\\"with nested quote\\\"\""));
    }
    ...
    public void TestConvertFromSimpleStringExpression()
    {
        ...
        Assert.AreEqual("\"simple string \\\"with nested quote\\\"\"",
            EditorUtility.ConvertFromSimpleStringExpression("simple string \"with nested quote\""));
    }
}