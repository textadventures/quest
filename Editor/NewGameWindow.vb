...
Public Class NewGameWindow
    ...
    Private Const k_regNameLang As String = "Language" ' Added by SoonGames
    ...
    Public Sub SetAvailableTemplates(templates As Dictionary(Of String, TemplateData))
        ...
        If lstTemplate.Items.Count > 0 Then
            ...
            If lastTemplate Is Nothing Then lastTemplate = TryCast(key.GetValue(k_regNameLang), String) ' Changed by SoonGames
