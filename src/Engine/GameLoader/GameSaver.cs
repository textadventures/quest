...
namespace QuestViva.Engine.GameLoader
{
    ...
    internal partial class GameSaver
    {
        ...
        private interface IElementsSaver
        {
            ...
            QuestViva.Engine.GameLoader.GameSaver GameSaver { set; }
        }
        ...
        private abstract class ElementSaverBase : IElementSaver
        {
            ...
            private QuestViva.Engine.GameLoader.GameSaver m_gameSaver;
            ...
            public QuestViva.Engine.GameLoader.GameSaver GameSaver
            {
