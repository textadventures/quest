...
async function initWasmPlayer(gameBytes, filename, bc = null, saveBytes = null, isPreview = false, recordWalkthrough = null, runWalkthrough = null, adjacentFiles = null) {
    ...
    setModuleImports("wasm-player", {
        ...
        beginWait: () => beginWait(),
        setTurnPending: (pending) => setTurnPending(pending),
...
// tab (see PlayCatalog.svelte's handleBrowserStart, which closes its previous
...
(function () {
    ...
    // either), but Electron's local-play.ts backs the picked file with a
