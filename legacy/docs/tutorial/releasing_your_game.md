...
For more on the Publish tool, including size limitations and what gets included in the .quest file, see [Publishing]({{ site.baseurl }}{% link publishing.md %}).
...
Now all you have to do is tell people about it! See [Publishing]({{ site.baseurl }}{% link publishing.md %}) for a list of places you can announce your game.
