...
Quest 5 is free, [open source](open_source.html) software for creating text adventure games. It is designed to be powerful, extensible and easy to learn. You can create games in any language — Quest has templates for English, French, German, Spanish, Dutch, Italian, Portuguese, Romanian, Esperanto, Russian and Icelandic.

You can [use Quest in your web browser](https://textadventures.co.uk/create) or [download the Windows desktop version](https://textadventures.co.uk/quest/desktop).
...
- **[Multi-media](multimedia.html)** — adding images, sounds and video
- **[User Experience](user_experience.html)** — customising the interface, fonts, panes and display verbs
- **[Characters (NPCs)](npcs.html)** — conversations, followers, and independent characters
- **[Introduction to RPGs](rpg-intro.html)** — stats, combat and character creation
...
Quest is discussed on [GitHub Discussions](https://github.com/textadventures/quest/discussions) and [Discord](https://textadventures.co.uk/community/discord). If you find a bug or want to request a feature, please use the [Issue Tracker](https://github.com/textadventures/quest/issues).

Quest is completely open source — the source code and this documentation both live [on GitHub](https://github.com/textadventures/quest). See the [Developers](developers.html) page if you'd like to contribute, and [Other Guides](other_guides.html) for community-created tutorials and libraries.
